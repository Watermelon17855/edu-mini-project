...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            ...
            <img src="{{ $course->thumbnail }}" class="img-fluid rounded shadow-sm mb-4" alt="{{ $course->title }}" style="width: 100%; max-height: 400px; object-fit: cover;">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 sticky-top" style="top: 20px;">
                <div class="card-body">
                    ...
                    <form action="{{ route('client.course.enroll', $course->id) }}" method="POST">
                        @csrf
                        <a href="{{ route('client.checkout', $course->id) }}" class="btn btn-primary ...">
                            <i class="bi bi-rocket-takeoff me-2"></i> ĐĂNG KÝ HỌC NGAY
                        </a>
                    </form>
